...
(function() {
	...
	var _messages = {
		...
		en: {
			...
			type_group_search: "History, Search, Grade",
			item_group_normal: "N",
			item_group_deluxe: "DX",
			item_group_ultimate: "UM",
			type_search_item: "Search",
			type_history: "History",
			type_search_intelli: "インテリジェンス",
			type_search_brave: "ブレイブ",
			type_search_grade_normal: "N",
			type_search_grade_deluxe: "DX",
			type_search_grade_ultimate: "UM",
			...
			icon_nx_renewable: "<span class='nxc-exist-nx-icon'>Nx</span>",
		...
		ja: {
			...
			type_group_search: "履歴・検索・グレード",
			item_grade_normal: "N",
			item_grade_deluxe: "DX",
			item_grade_ultimate: "UM",
			type_search_item: "検索",
			type_history: "履歴",
			type_search_intelli: "インテリジェンス",
			type_search_brave: "ブレイブ",
